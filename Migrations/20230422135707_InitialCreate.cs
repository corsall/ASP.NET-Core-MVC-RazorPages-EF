...
namespace lab.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "dovidnyk_clientiv",
                columns: table => new
                {
                    KODKL = table.Column<int>(type: "int(11)", nullable: false),
                    NAMEKL = table.Column<string>(type: "varchar(45)", maxLength: 45, nullable: true, collation: "utf8mb4_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.KODKL);
                })
                .Annotation("MySql:CharSet", "utf8mb4")
                .Annotation("Relational:Collation", "utf8mb4_general_ci");

            migrationBuilder.CreateTable(
                name: "dovidnyk_dostavki",
                columns: table => new
                {
                    KODDOS = table.Column<int>(type: "int(11)", nullable: false),
                    TUPDOS = table.Column<string>(type: "varchar(45)", maxLength: 45, nullable: true, collation: "utf8mb4_general_ci")
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.KODDOS);
                })
                .Annotation("MySql:CharSet", "utf8mb4")
                .Annotation("Relational:Collation", "utf8mb4_general_ci");

            migrationBuilder.CreateTable(
                name: "dovidnyk_produkcii",
                columns: table => new
                {
                    KODPR = table.Column<int>(type: "int(11)", nullable: false),
                    NAMEPR = table.Column<string>(type: "varchar(45)", maxLength: 45, nullable: true, collation: "utf8mb4_0900_ai_ci")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CINA = table.Column<decimal>(type: "decimal(4,2)", precision: 4, scale: 2, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.KODPR);
                })
                .Annotation("MySql:CharSet", "utf8mb4")
                .Annotation("Relational:Collation", "utf8mb4_general_ci");
            ...
            migrationBuilder.CreateTable(
                name: "zamovlenya_productcii",
                columns: table => new
                {
                    NZ = table.Column<int>(type: "int(11)", nullable: false),
                    KODKL = table.Column<int>(type: "int(11)", nullable: false),
                    DATEZ = table.Column<DateOnly>(type: "date", nullable: false),
                    DATESP = table.Column<DateOnly>(type: "date", nullable: true),
                    KODDOS = table.Column<int>(type: "int(11)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PRIMARY", x => x.NZ);
                    table.ForeignKey(
                        name: "zam_prod_dov_cientiv",
                        column: x => x.KODKL,
                        principalTable: "dovidnyk_clientiv",
                        principalColumn: "KODKL",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "zam_prod_dov_dost",
                        column: x => x.KODDOS,
                        principalTable: "dovidnyk_dostavki",
                        principalColumn: "KODDOS",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4")
                .Annotation("Relational:Collation", "utf8mb4_general_ci");
            ...
            migrationBuilder.CreateTable(
                name: "vmist_zamovleny",
                columns: table => new
                {
                    id = table.Column<int>(type: "int(11)", nullable: false),
                    NZ = table.Column<int>(type: "int(11)", nullable: false),
                    KODPR = table.Column<int>(type: "int(11)", nullable: false),
                    KIL = table.Column<int>(type: "int(11)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_vmist_zamovleny", x => x.id);
                    table.ForeignKey(
                        name: "vmist_zam_dov_prod",
                        column: x => x.KODPR,
                        principalTable: "dovidnyk_produkcii",
                        principalColumn: "KODPR",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "vmist_zam_zam_prod",
                        column: x => x.NZ,
                        principalTable: "zamovlenya_productcii",
                        principalColumn: "NZ",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4")
            ...
            migrationBuilder.CreateIndex(
                name: "vmist_zam_dov_prod_idx",
                table: "vmist_zamovleny",
                column: "KODPR");

            migrationBuilder.CreateIndex(
                name: "vmist_zam_zam_prod_idx",
                table: "vmist_zamovleny",
                column: "NZ");

            migrationBuilder.CreateIndex(
                name: "zam_prod_dov_cientiv_idx",
                table: "zamovlenya_productcii",
                column: "KODKL");

            migrationBuilder.CreateIndex(
                name: "zam_prod_dov_dost_idx",
                table: "zamovlenya_productcii",
                column: "KODDOS");
        }
